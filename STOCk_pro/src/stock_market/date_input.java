...
public class date_input extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextField2.setBounds(110, 140, 70, 30);
        ...
        jLabel5.setBounds(380, 140, 60, 30);
        getContentPane().add(jTextField3);
        jTextField3.setBounds(430, 140, 70, 30);

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel6.setText("Hidden Layers");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(200, 140, 90, 30);
        ...
        jComboBox2.setBounds(120, 210, 100, 30);

        jLabel10.setIcon(new javax.swing.ImageIcon("E:\\Study Mat\\5th sem\\Project\\Final\\StockMarketAnalysis\\STOCk_pro\\STOCk_pro\\logo.jpg")); // NOI18N
        getContentPane().add(jLabel10);
        jLabel10.setBounds(0, 0, 90, 90);

        jLabel11.setIcon(new javax.swing.ImageIcon("E:\\Study Mat\\5th sem\\Project\\Final\\StockMarketAnalysis\\STOCk_pro\\STOCk_pro\\credits.jpg")); // NOI18N
        getContentPane().add(jLabel11);
        jLabel11.setBounds(0, 480, 600, 50);

        jLabel9.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel9.setText("Select Company");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(10, 210, 100, 30);

        jLabel12.setIcon(new javax.swing.ImageIcon("E:\\Study Mat\\5th sem\\Project\\Final\\StockMarketAnalysis\\STOCk_pro\\STOCk_pro\\iiita.jpg")); // NOI18N
        getContentPane().add(jLabel12);
        jLabel12.setBounds(90, 0, 510, 90);
        ...
        jLabel3.setBounds(0, 80, 820, 400);
...
private void jTextField2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField2ActionPerformed
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        ...
        if (s.equals("Google")) {
            ...
            sm.setFileName("E://Study Mat//5th sem//Project//Final//StockMarketAnalysis//STOCk_pro//google.txt");
            System.out.println(s);
        } else if (s.equals("Yahoo")) {
            sm.setFileName("E://Study Mat//5th sem//Project//Final//StockMarketAnalysis//STOCk_pro//yahoo.txt");
            System.out.println(s);
        } else if (s.equals("Ford")) {
            sm.setFileName("E://Study Mat//5th sem//Project//Final//StockMarketAnalysis//STOCk_pro//ford.txt");
            System.out.println(s);
        } else if (s.equals("Adobe")) {
            sm.setFileName("E://Study Mat//5th sem//Project//Final//StockMarketAnalysis//STOCk_pro//adobe.txt");
            System.out.println(s);
        }
