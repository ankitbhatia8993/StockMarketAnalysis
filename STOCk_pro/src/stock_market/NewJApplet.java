...
public class NewJApplet extends Applet implements ActionListener { int yy, mm, dd; NewJApplet cal; Panel p; TextField yyText, mmText, ddText;
...
public void init() { setLayout(new BorderLayout());
  ...
  add(cal  = new NewJApplet(yy, mm, dd), BorderLayout.NORTH);
  p = new Panel();
